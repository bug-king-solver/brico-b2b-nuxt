  ...
  <main class="main">
    ...
    <div class="container">
      <div class="cart-message carted" style="display: none">
        ...
        >
        <span>{{ $t("has been added to cart successfully.") }}</span>
      </div>
      ...
      <div class="cart-message removed" style="display: none">
        <strong class="single-cart-notice" v-if="currentProduct"
          >“{{ currentProduct.name }}”</strong
        >
        <span>{{ $t("has been successfully removed.") }}</span>
      </div>

      <div class="wishlist-title">
        <h2 class="p-2">
          {{ $t("My wishlist on Porto Shop ") }}{{ currentDemo }}
        </h2>
      </div>
        ...
        <table class="table table-wishlist mb-0">
          <thead>
            <tr>
              ...
              <th class="status-col">{{ $t("Stock status") }}</th>
          ...
          <tbody>
            ...
            >
              ...
              <td>
                <span class="stock-status">{{ $t("In stock") }}</span>
              </td>
              <td class="action">
                <a
                  href="javascript:;"
