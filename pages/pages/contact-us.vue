  ...
  <main class="main">
    ...
    <div class="container contact-us-container">
      <div class="contact-info">
        <div class="row">
          <div class="col-12">
            <h2 class="ls-n-25 m-b-1">{{ $t("Contact Info") }}</h2>
      ...
      <div class="row">
        <div class="col-lg-6">
          <h2 class="mt-6 mb-2">{{ $t("Send Us a Message") }}</h2>
        ...
        <div class="col-lg-6">
          <h2 class="mt-6 mb-1">{{ $t("Frequently Asked Questions") }}</h2>
          <div id="accordion">
