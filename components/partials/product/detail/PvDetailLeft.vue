<template>
  <div class="product-single-details">
    ...
    <div class="ratings-container" v-if="isTitle">
    ...
    <hr class="short-divider" v-if="isTitle" />

    <div class="price-box pt-1" v-if="product.price" key="singlePrice">
    ...
    <div class="price-box pt-1" v-else>
