<template>
  <div class="product-single-details">
    ...
    <ul class="single-info-list">
      ...
      <li v-if="product.product_tags && product.product_tags.length > 0">
        TAGS:
        <strong>
          <nuxt-link
    ...
    >
      <div class="product-single-filter mb-2 mr-5" v-if="vColors.length > 0">
      ...
      <div class="product-single-filter mb-2 mr-5" v-if="vSizes.length > 0">
