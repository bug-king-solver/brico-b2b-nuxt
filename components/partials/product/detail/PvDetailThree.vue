    ...
    <div class="product-single-details">
      ...
      <div class="product-info">
        <div class="w-75 p-3 text-center">
          O 3 rate da <span><strong> €254.33</strong></span> senza interessi.
          <span class="fw-bold"> scalapay</span>
        </div>
      </div>
      ...
      <div class="d-block d-sm-flex align-items-center">
        ...
        <div class="mt-2">
          <div class="d-flex">
            <div class="attr-title">Stato:</div>
            <div class="attr-value text-success fw-700">Disponible</div>
          </div>
          <div class="d-flex">
            <div class="attr-title">Ultimo ordinato:</div>
            <div class="attr-value text-success fw-700">1 PZ 26/08/2022</div>
          </div>
        </div>
      </div>

      <div class="d-block d-sm-flex align-items-center mt-3 mt-sm-0">
      ...
      <div class="d-flex align-items-center">
        <nuxt-img
          src="/images/product-detail-img.png"
          alt=""
          srcset=""
          class="bg-white mr-4"
        />
        <div class="intro-section">
          <div class="intro-title">Migliori E-commerce d’italia</div>
          <div class="intro-description">
            N°1 fiardino e artigianato 2022/2023
          </div>
        </div>
      </div>
    </div>
...
import ProductAttributes from "~/components/partials/product/attributes/ProductAttributes";
import PvProductNav from "~/components/partials/product/PvProductNav";
import SocialIcon from "~/components/partials/product/social-icon/SocialIcon";
...
export default {
  ...
  methods: {
    ...
    ...mapActions("wishlist", ["addToWishlist", "getWishList"]),
    addCart: function () {
