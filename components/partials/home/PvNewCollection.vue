  ...
  <section class="new-products-section appear-animate" v-animate>
    <div class="container">
      ...
      <div
        ...
        style="
          background: #2a95cb center/cover
            url('./images/home/banners/banner-4.jpg');
        "
      >
        <div class="banner-content row align-items-center mx-0">
          <div class="col-md-9 col-sm-8">
            <h2
              class="text-white text-uppercase text-center text-sm-left ls-n-20 mb-md-0 px-4"
            >
              <b class="d-inline-block mr-3 mb-1 mb-md-0">Big Sale</b>
              All new fashion brands items up to 70% off
              <small class="text-transform-none align-middle"
                >Online Purchases Only</small
              >
            </h2>
          </div>
          <div class="col-md-3 col-sm-4 text-center text-sm-right">
            <nuxt-link class="btn btn-light btn-white btn-lg" to="/shop"
              >View Sale</nuxt-link
            >
          </div>
        </div>
