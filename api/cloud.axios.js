...
const api = process.env.API_URL || "https://deodato.omnicommerce.cloud";
const applicationToken =
  process.env.APPLICATION_TOKEN || "eaf2f95635a43f2:ff4313e9a93a9d6";

export const apiSearch = `${api}/api/method`;
export const apiResource = `${api}/api/resource`;
export const loginUrl = "/mymb_ecommerce.utils.auth.sigin";
